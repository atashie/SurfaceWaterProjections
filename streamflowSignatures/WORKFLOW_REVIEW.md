...
**Location:** `tests/qa_qc_signatures.R` lines 77-430
...
| QA/QC flagging | `tests/qa_qc_signatures.R` | 77-430 |
| QA/QC visualization | `tests/visualize_qa_qc.R` | 70-650 |
| Smoke test | `tests/smoke_test.R` | 1-130 |
