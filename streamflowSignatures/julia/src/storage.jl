...
function calculate_average_storage(
    ...
    return generate_stats(annual_df; value_cols=["avg_storage"], trend_completeness=trend_completeness, decade_completeness=decade_completeness, changepoint=changepoint)
end
