...
yesterdaysDate = '2023-01-16'	# historic data is released every day for the day prior
forecastDate = '17JAN2023'		# 
...
seas5StartDate = as.Date('2023-01-01') # + ncvar_get(ncin_seas5, 'lead_time') for calculating actual dates
