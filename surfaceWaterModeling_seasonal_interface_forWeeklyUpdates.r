...
yesterdaysDate = '2022-12-15'	# historic data is released every day for the day prior
forecastDate = '16DEC022'		# 
...
seas5StartDate = as.Date('2022-12-01') # + ncvar_get(ncin_seas5, 'lead_time') for calculating actual dates
